...
public class Q03_CollectionsMethodsTask {
    ...
    public static void main(String[] args) {
        ...
        Collections.sort(arrlist,Collections.reverseOrder());//reverseOrder() ters sıralar
                                                            // sort() sıralar
        System.out.println("ters sıraladıktan sonra arrlist: "+arrlist);

        Collections.shuffle(arrlist);// rastgele karıştır
        System.out.println("shuffle yaptıktan sonra "+arrlist);

        Collections.rotate(arrlist,3);// belirtilen listedeki öğeleri kaydırır,
